...
b <- read.csv("seq.glom.15.no0.csv",row.names=1) #from 2015&2016
b <- read.csv("seq.glom.17.no0.csv",row.names=1) #from 2017
b <- read.csv("seq.glom.18.no0.csv",row.names=1) #from 2018
...
negco15 <- data.frame(output[["Negative Cohesion"]])
posco15 <- data.frame(output[["Positive Cohesion"]])

negco17 <- data.frame(output[["Negative Cohesion"]])
posco17 <- data.frame(output[["Positive Cohesion"]])

negco18 <- data.frame(output[["Negative Cohesion"]])
posco18 <- data.frame(output[["Positive Cohesion"]])
